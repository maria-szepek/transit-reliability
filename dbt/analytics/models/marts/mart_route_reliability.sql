...
select
    ...
    (
        0.20 * b.avg_stop_connectivity +
        0.20 * b.avg_trips_per_hour +
        0.10 * b.min_trips_per_hour +
        0.15 * (1 - coalesce(b.avg_transfer_risk, 0.5)) +
        0.10 * (1 / (1 + coalesce(b.headway_stddev, 5))) +
        0.15 * coalesce(t.time_reliability, 0.5) +
